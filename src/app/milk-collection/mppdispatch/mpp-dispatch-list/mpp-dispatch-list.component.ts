...
@Component({
  selector: 'app-mpp-dispatch-list',
  templateUrl: './mpp-dispatch-list.component.html',
  styleUrls: ['./mpp-dispatch-list.component.css']
})
export class MppDispatchListComponent implements OnInit{
  closeResult: string = "";
  ...
  originalData: any[] = [];
    ...
    columnDefs: ColDef[] = [
      ...
      { headerName: "No of Can", field: 'no_of_can', resizable: true, width: 130 },
  ...
  GetMilkDispatchList() {
    if (this.searchForm.valid) {
      ...
      this._milkCollectionService.GetMppMilkDispatchList( this.newModel).subscribe(response => {
