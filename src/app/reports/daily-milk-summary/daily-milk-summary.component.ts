...
@Component({
  selector: 'app-daily-milk-summary',
  templateUrl: './daily-milk-summary.component.html',
  styleUrls: ['./daily-milk-summary.component.css']
})
export class DailyMilkSummaryComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    if (this.searchForm.valid) {
      ...
      this._reportService.dailyMilkSummaryReport(this.searchModel).subscribe(response => {
