...
@Component({
  selector: 'app-farmer-history-report',
  templateUrl: './farmer-history-report.component.html',
  styleUrls: ['./farmer-history-report.component.css']
})
export class FarmerHistoryReportComponent implements OnInit{
  ...
  FarmerHistory() {
    if (this.searchForm.valid) {
      ...
      this._reportService.FarmerHistoryReport(this.searchModel).subscribe(response => {
