...
@Component({
  selector: 'app-sample-wise-checklist',
  templateUrl: './sample-wise-checklist.component.html',
  styleUrls: ['./sample-wise-checklist.component.css']
})
export class SampleWiseChecklistComponent implements OnInit{
  ...
  sampleWiseCheckList() {
    if (this.searchForm.valid) {
      ...
      this._reportService.sampleWiseCheckListReport(this.searchModel).subscribe(response => {
