...
@Component({
  selector: 'app-zero-checklist-report',
  templateUrl: './zero-checklist-report.component.html',
  styleUrls: ['./zero-checklist-report.component.css']
})
export class ZeroChecklistReportComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    if (this.searchForm.valid) {
      ...
      this._reportService.zeroLrCheckListReport(this.searchModel).subscribe(response => {
