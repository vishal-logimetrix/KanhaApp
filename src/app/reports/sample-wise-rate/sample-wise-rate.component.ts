...
@Component({
  selector: 'app-sample-wise-rate',
  templateUrl: './sample-wise-rate.component.html',
  styleUrls: ['./sample-wise-rate.component.css']
})
export class SampleWiseRateComponent implements OnInit{
  ...
  constructor(private _masterService: MasterService, private _reportService: ReportService){
    this.searchForm = new FormGroup({
      ...
      Adulteration_Only: new FormControl('', Validators.required),
      rejected_only: new FormControl('', Validators.required),
  ...
  sampleWiseRateCheckList() {
    if (this.searchForm.valid) {
      this.searchModel = Object.assign({}, this.searchForm.value);
      // console.log('__________________entered_data_______________', this.searchModel);
      this._reportService.sampleWiseRateCheckListReport(this.searchModel).subscribe(response => {
