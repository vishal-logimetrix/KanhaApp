...
@Component({
  selector: 'app-dpu-status',
  templateUrl: './dpu-status.component.html',
  styleUrls: ['./dpu-status.component.css']
})
export class DPUStatusComponent implements OnInit{
  ...
  dpuStatusHistory() {
    if (this.searchForm.valid) {
      ...
      this._reportService.dpuStatusHistoryReport(this.searchModel).subscribe(response => {
