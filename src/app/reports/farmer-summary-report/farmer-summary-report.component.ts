...
@Component({
  selector: 'app-farmer-summary-report',
  templateUrl: './farmer-summary-report.component.html',
  styleUrls: ['./farmer-summary-report.component.css']
})
export class FarmerSummaryReportComponent implements OnInit {
  ...
  mppModel: any = {};
    ...
    columnDefs: ColDef[] = [
      ...
      { headerName: "FAT%", field: 'avg_fat', resizable: true, width: 100 },
      { headerName: "SNF%", field: 'avg_snf', resizable: true, width: 100 },
      { headerName: "FAT KG", field: 'kg_fat', resizable: true, width: 100 },
      { headerName: "SNF KG", field: 'kg_snf', resizable: true, width: 100 },
      { headerName: "Rate", field: 'rate', resizable: true, width: 100 },
      { headerName: "AMT", field: 'amount', resizable: true, width: 100 },
      { headerName: "No Of Shift", field: 'no_of_shift', resizable: true, width: 100 },
    ];
  ...
  FarmerCollectionSummeryReport() {
    if (this.searchForm.valid) {
      this.searchModel = Object.assign({}, this.searchForm.value);
      this._reportService.FarmerCollectionSummeryReport(this.searchModel).subscribe(response => {
