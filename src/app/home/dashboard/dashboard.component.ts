...
// import { AlertService } from 'src/app/Auth/common/Services/alert.service';
@Component({
...
export class DashboardComponent implements OnInit{
  ...
  constructor(private _dashboardService: DashboardServiceService,private modalService: BsModalService,private _toastrService: ToastrService){
