...
@Component({
  selector: 'app-dock-history',
  templateUrl: './dock-history.component.html',
  styleUrls: ['./dock-history.component.css']
})
export class DockHistoryComponent implements OnInit{
  ...
  dockHistory() {
    if (this.searchForm.valid) {
      ...
      this._reportService.dockHistoryReport(this.searchModel).subscribe(response => {
