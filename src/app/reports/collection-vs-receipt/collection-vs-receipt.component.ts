...
@Component({
  selector: 'app-collection-vs-receipt',
  templateUrl: './collection-vs-receipt.component.html',
  styleUrls: ['./collection-vs-receipt.component.css']
})
export class CollectionVsReceiptComponent implements OnInit{
  ...
  ActualComposeReport() {
    if (this.searchForm.valid) {
      ...
      this._reportService.ActualComposeReport(this.searchModel).subscribe(response => {
