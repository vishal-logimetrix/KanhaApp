...
@Component({
  selector: 'app-dock-checklist-report',
  templateUrl: './dock-checklist-report.component.html',
  styleUrls: ['./dock-checklist-report.component.css']
})
export class DockChecklistReportComponent implements OnInit{
  ...
  dockCheckList() {
    if (this.searchForm.valid) {
      ...
      this._reportService.dockCheckListReport(this.searchModel).subscribe(response => {
